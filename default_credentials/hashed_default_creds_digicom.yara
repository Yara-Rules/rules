...
rule md5_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for digicom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="e3afed0047b08059d0fada10f400c1e5"
    $a1="d41d8cd98f00b204e9800998ecf8427e"
    $a2="21232f297a57a5a743894a0e4a801fc3"
    $a3="d1f9cc6dcce0518273c68f03cbbb51f8"
...
strings:
    ...
    $a3="018231af746bda59ff2c0d1c20f9dd6a95b16f06"
...
rule sha384_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="f41c24d0b879b7967690d4b437fc987a141ab3bda41880433cb4497bb79306901da78d446a9ca571849fc64a31d4aadb"
...
strings:
    ...
    $a3="4105cace91bc98ece25fabcb60c9fc3ea2ada284b1e49d63b3113a64"
...
rule sha512_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="6816454077efddfd241976b531055faa8a423d86363fbcd2733698bb2c08e311d319400f457937ba322f5dcf93cc5dcc47ec419af99afb74057d5473b86a4304"
...
rule sha256_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="0a0a80b74c33b9707b29e2d3e843ea0bdc28b9b2177791086fcc2e44d6063225"
...
rule blake2b_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="5191bee1b5cbd86940191eb57c87009877b208e07957a77a837505f16a2d9c673a3d59f6df132ecc265cd9f2bb00e515751ebc22237c1f8db56f3ecdc35e52e4"
...
rule blake2s_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="c7fe695130dfb4321a8f499ed3d6f111bdd6e30796cda9fb4a9b7d959aa2bc76"
...
rule sha3_224_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="0ae930373788b765550bb9be96b7042d6ed8628cad032f991a370d80"
...
rule sha3_256_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="1cfbad3ce167d4078efc920fb50fc41cb6478d2374c8b5eb63fbe6ed32721e7c"
...
rule sha3_384_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="c453762ee2489eeb8811cf26f8f1aae02205af74197e43ac64acef4eb8d03c781286908d8d25aff52a7094706fd30a3f"
...
rule sha3_512_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="cd2899db9a0e8627e42127fd06eae53ee196fd400a8c82744d5e369134618cd260006893469454cce8b5e59b4b2a948ce45a5ceaf3a7921820f292a0401fd3ac"
...
rule base64_hashed_default_creds_digicom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
