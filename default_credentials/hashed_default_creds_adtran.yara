...
meta:
    ...
    Description="Hashed values of default credentials for adtran. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="21232f297a57a5a743894a0e4a801fc3"
    $a1="5f4dcc3b5aa765d61d8327deb882cf99"
    $a2="d41d8cd98f00b204e9800998ecf8427e"
    $a3="7f1a02ddd2cf3df129eb99c8408a5e28"
    $a4="d41d8cd98f00b204e9800998ecf8427e"
    $a5="d41d8cd98f00b204e9800998ecf8427e"
    $a6="d41d8cd98f00b204e9800998ecf8427e"
    $a7="dc647eb65e6711e155375218212b3964"
condition:
...
strings:
    ...
    $a3="b838a6135ad6c6370ae58a20f48ac01b21179962"
    ...
    $a7="8be3c943b1609fffbfc51aad666d0a04adf83c9d"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="ede75ea154e380731bc06472af478fa1c3bc0e387eddc4ae8a75e1fa6a6fda7f4269ed8467ebe32bff044098d53c2832"
    ...
    $a7="d3a1ad34a5f0d265d8c0441d85532a95d02fcca0450646c21f1585cfc521843cd423d02f53e9205390706cc15f3a06fe"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="61cca4b14a110fe2a6430f7f257716bcfd21f74d87f11ab9e11cfabb"
    ...
    $a7="a1308b7983fef7def9ffd06bed7ff767fa4216baf9d9d911af1e7e2e"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="b02e48c9b9ae0157ea3d29bf70e89108f29910f0ac70b2e9b912fef4a96fbda20ca7b18a6343d922154882f62c355f2cbfc19f097f8726e98b75d0115a433086"
    ...
    $a7="e6c83b282aeb2e022844595721cc00bbda47cb24537c1779f9bb84f04039e1676e6ba8573e588da1052510e3aa0a32a9e55879ae22b0c2d62136fc0a3e85f8bb"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="28f840d978e2314001e1bafaca7dad6265c22316bfe0a4af5fa861add52b4233"
    ...
    $a7="e7cf3ef4f17c3999a94f2c6f612e8a888e5b1026878e4e19398b23bd38ec221a"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="bffeab3931b645ad47a6859da901fd25f7f16748b59cea4abad5f33f7e3affd926b902eadd71fef920c139bb458f0199d7569e7d11498cfc8552e989456446be"
    ...
    $a7="3db53bf0303c49d82bf5bbf88227ce35907a84df015d036bb486a428da15b450c30c2635d9fbaf172749ea45e45fb914913ad1e977ffa3f1a6e18e9818ed7ba9"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="cd00c607dbb0034f05b42a889b7f7e8500f9e97d0fcf6b7789d49714805dd973"
    ...
    $a7="1322d801700576cbbff20d4086fc31af9ddda03117da78a80e6b45b39a0a35d2"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="ca755cb7909cc9348e18c9ba0bf07f27ab06d9100730f968f667888f"
    ...
    $a7="9a5b642b515c16b138a8bc7cc38b262e6f738fc2ca228e18a9ec5d3f"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="86df541e318a05504b5066ecf16c2eb4727431422106b18633657f2851be1d79"
    ...
    $a7="545e50bcc34933b23852a89857e05d6a524b2101e79858d6f65c99a36be4e862"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="81f6fcd531de6413ec52b15d8e980b22ed938289e3866ba23551a8cfcb0ce3cf7a8ac24301ff8dd9698604400f8c9773"
    ...
    $a7="2c6b4328f66cf2dfd90c24d5e5d2ee6f704d5aed8696466120be3c6eb240ea77e98347234804a5dddbeabadbc8d9bc39"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a3="d1ef6cbdb5e9202b95d73034fd62a786671433aeb8a2a1d4760a3381cf9da40327104bf63ac00f49f763c18a947832e495b20ff810e9d7f5d5397cc08e2941b1"
    ...
    $a7="01bcfd81213def9ea2369b1f8d668bc44f9d66ecc01b2f95d09fc3594c74bf12f0b80cbe5c8abff328b0c68c165b1404c078ff77fb063e43b01b5404259881b4"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
