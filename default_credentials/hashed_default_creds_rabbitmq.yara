...
rule md5_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for rabbitmq. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
...
rule sha1_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha384_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha512_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha256_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule blake2b_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule blake2s_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha3_224_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha3_256_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha3_384_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha3_512_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule base64_hashed_default_creds_rabbitmq
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
