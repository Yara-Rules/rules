...
rule md5_hashed_default_creds_divar
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for divar. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="21232f297a57a5a743894a0e4a801fc3"
    $a1="d41d8cd98f00b204e9800998ecf8427e"
    $a2="4b2a1529867b8d697685b1722ccd0149"
    $a3="d41d8cd98f00b204e9800998ecf8427e"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha1_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="40b4f25b1fd956b576d880db2b41182e0444bd1d"
    $a3="da39a3ee5e6b4b0d3255bfef95601890afd80709"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha384_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="74a066402dbf91dcf3de76eeba0406d7233c5033642b82d8c133abeaa81c7f49590ac5f82381bf455231d3db636264a6"
    $a3="38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da274edebfe76f65fbd51ad2f14898b95b"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha224_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="7a8cff2f745efa1dd50e5be48bd5440a9ccfac498c1058391abab0cb"
    $a3="d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha512_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="a8d73e712d9257a75bce54754e0ad3074894e29feeec1709f9e47b761dc38d7ab923a62f1b4883a19569115e8b68850cc86b27fda81a0daa5305538e4d910168"
...
rule sha256_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="d35ca5051b82ffc326a3b0b6574a9a3161dee16b9478a199ee39cd803ce5b799"
    $a3="e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2b_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="86a6d22d84baf1f49c43fc8e9b60a95920c54a5ae840788826732ef74da6884ca3b4ebada8190542b0983477fd1e95cb2f3c2b235bfa9d3424f871c4ff869a69"
...
rule blake2s_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="bb03c487b908d80b317bbbb78b0deb4328f5cf04d027e6768bd8854eae478bc7"
    $a3="69217a3079908094e11121d042354a7c1f55b6482ca1a51e1b250dfd1ed0eef9"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_224_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="83c9402b8e461510b86ffd845654ba69548e14b68cef6bb483821944"
    $a3="6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_256_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="4ad571843d929affe7de7a5f958449f6cd5ebd62c59b62c5483cac843307ac69"
    $a3="a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_384_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="9b13d77c790257adb58c37007c4bfd2cf0672dc78b4a0cd893306263a2666b734d390d4366d2af6c73b7aef6487598eb"
    $a3="0c63a75b845e4f7d01107d852e4c2485c51a50aaaa94fc61995e71bbee983a2ac3713831264adb47fb6bd1e058d5f004"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_512_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a2="4e12256551eded47fbe90ac8a6addeec97f450d0ac9219f131007319793fe4bb6521e808958de577d18aa471901f07779674ad3b9aabc3ed7b3b9145c378a72c"
...
rule base64_hashed_default_creds_divar
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
