...
rule md5_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for develcon. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="d41d8cd98f00b204e9800998ecf8427e"
    $a1="a75a1789547188e39e2e344c286d2b62"
...
rule sha1_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="bec8a661ee2c4d66e37f8a030273fd47d981744e"
...
rule sha384_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="70fa8720acbae065b48386cef178a37fd2933fc43509d71456bc4e024c20bc4100999fb461c2e8e5efc557ee03d0b092"
...
rule sha224_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="897c65771049bfa8c3b90cb268e29f4f2842d03bfc4391208c1c3dfa"
...
rule sha512_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="4ac30e384f8763da0185cf6c3bd41dbb154a2eed8f957a5d95a83f854d9426d586c845f9e92432bc01792bbe4f9657f366407a3b0565590dcdb40b17b33b6ff9"
...
rule sha256_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="ef304fbeab13fe6be160d785fcecaa5620c846e7ad697e2915bfe0612fa9cb67"
...
rule blake2b_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="bf64cc560a7b136a835e21e9d6d2ec1c4b1a1288b0b0b5507e7af3185053a65cc4be7c66501053524f69c9d4b6878a53165e1fb50c7461aadd5311ddf8f0d6d3"
...
rule blake2s_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="69b2db76375bcb31782a06127e0792dcd402fca332cd65a1bc76379937c1f646"
...
rule sha3_224_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="4727a235c4c275618764d9b0f1443a27070af70079b241fed197ce26"
...
rule sha3_256_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="ecd6a4119607489f5193d413ef81201bf0f12565acbf25e2280a1c6aec3517af"
...
rule sha3_384_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="8bd95b280981ba754e32a4ed8477c4230924e3db64b8eecde374945eda63798334dfe9552e69522463ecf125c7aaf4cf"
...
rule sha3_512_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a1="b6bc2264186adca0a4ddc182203c4ea7e52a1039a6bcea672ff9bdaf6ef74b9504bf8d89871f42d760974bcefde7ed1d318a9a1a9f8092ec67f829f7d10dd9ab"
...
rule base64_hashed_default_creds_develcon
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
