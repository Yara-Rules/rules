...
meta:
    ...
    Description="Hashed values of default credentials for sitecom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    ...
    $a5="f3ef258757994c916d2d93fa71b89c41"
    $a6="d41d8cd98f00b204e9800998ecf8427e"
    $a7="7c1616cb68c1d8e3b7ea1669633c5835"
condition:
...
strings:
    ...
    $a5="bfe4f76caade975d3cdac7ad21f25739278a7a82"
    $a6="da39a3ee5e6b4b0d3255bfef95601890afd80709"
    $a7="e94cf3e1f47bb5515271514e37dcdc39ee4ae45a"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="c47ae54cbc38993916567e0b2650cb157428ad09eb1bc97b8e7cf90636f3d38dafda78a9fa1d5a4a02460399672bd5de"
    $a6="38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da274edebfe76f65fbd51ad2f14898b95b"
    $a7="6f9ccb3f79079d827d5afad21de5bc0d0ac1bc86de6b3e537a5c709296a07755feb78584dfa29d2a23b66ae2ce6b8fcf"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="719dd67a13858c07ba0c4686816412b1aed59c8b721c53b7bd6bc7bb"
    $a6="d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f"
    $a7="87bad50b0fa4a4f7640898db163d73fbdd27f5a25c89a7a733f10143"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="0ed0f6c9be2060352148618a99ea98b3bc350825d0f92804d8f08bd7f3ac1fc603a816e23d2924debac27d0c09533ff01c9b9e10bbf322efc2e7a75dc16feb59"
    ...
    $a7="0b235e7815d1e8da9c79007a819aaa11de610c028560823ac8fe95b3f80315ca3e6696f0bc081d4c8afd14913a001aa839b76109512023c70427b39c01a7a255"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="6d3ad600449950b3a6584fd9c1177d2aaff14193a71b7b003eac8f55e28ae693"
    $a6="e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
    $a7="6d08027dc738a3c47746a0f1a4f4ed113d91d59f188d934a6c3f26f6708c9074"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="451d7eefe933258f70b5734ae6dd9c7b8070586aa1553b68ddc4977ff1a4451b8582d5d69e533b599381bf22a0ab736fff88f6ec5afdf9c5a19c86bc4b42b595"
    ...
    $a7="9773982cea756ccafc2becf32f387a4f4561ba211cffff461bfc175333ee8f76cb7ad9c5b6efdd82d7e98c6ca8d27dac2c9bc26c1858e73a1aec5f7b63655633"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="15b07bcce07a6a4add2cbee9517cefa335ffc60c5aef4e6a1fb175d4e1b68f6c"
    $a6="69217a3079908094e11121d042354a7c1f55b6482ca1a51e1b250dfd1ed0eef9"
    $a7="f2ebbef3763bab8a97b91d1356581866a6a23253ba305b5922e5fe9afe4e8fe2"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="a0b9b016eaf7f696a0fd912f9b64459b2f4d373b7c2cf4a675b548cc"
    $a6="6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7"
    $a7="764db5525a554efd2b464ec399a5a8e8da2153b0f989fbb64dd930c3"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="df403d86f5a2260f1d124832661af668650f7bf0886855b14b32333bbb057039"
    $a6="a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a"
    $a7="9073a5bd9ac717b27af9fce3d27357b5df422102a51844e2221aaf9d36d057ce"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="8eddf04478310706e7855b45a4209048136be7a9dac3fe8f9d38bdc43d650fcf6691eb3bfa567bdf2b349d483603e415"
    $a6="0c63a75b845e4f7d01107d852e4c2485c51a50aaaa94fc61995e71bbee983a2ac3713831264adb47fb6bd1e058d5f004"
    $a7="b69745e6b5ffb2a2b6fe7634c1e56962462b96c3c7d4c9269f61b9739c63c9b056d5fa82cbd16c5252c9c9f824b7435c"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a5="4e74cb10a43a58d2a253724c1dba1cbcdb87c483e0a70672870411ef3e0d2e4a5c52de3c7f849556e50795057e3112f599efd6b8916e0a3e6295a6cc1baa625c"
    ...
    $a7="44e70018482d2647304fc7359ee023e017b51c4f278bf1da3471b12b4ea82a78266eda256f5cf9d46da97c383c14d9b269c8448492fd12258d3373c96323421b"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
