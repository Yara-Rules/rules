...
rule md5_hashed_default_creds_snom
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="60eb0f73e33ce3ffd4e51d974447db53"
    $a1="d41d8cd98f00b204e9800998ecf8427e"
    $a2="7b7bc2512ee1fedcd76bdc68926d4f7b"
    $a3="4a7d1ed414474e4033ac29ccb8653d9b"
...
rule sha1_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="6cd00776a079723548b5fe2980449e5262e40641"
    $a1="da39a3ee5e6b4b0d3255bfef95601890afd80709"
    $a2="1eda23758be9e36e5e0d2a6a87de584aaca0193f"
    $a3="39dfa55283318d31afe5a3ff4a0e3253e2045e43"
...
meta:
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="69cb36bf7ef1783fe5e1e7ac7c413b76f02c35758b246a9af9cfa7cb4e2b3809de5ad7eb9d38aff88abdaeca34cf7683"
    ...
    $a3="b034e6d9b4da9ec8962957bdce03b507b67dd5d40f821ab7f732d3591283253342d136c55c8eece0e1a50e1f724c2dde"
...
rule sha224_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="3e316666f363d86121564dca3b85c5f6ab7e7bbce99b7f13b42ac9d7"
    $a1="d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f"
    $a2="6f4a35b825e20e94b581661916d82a96d4259b95cdf26f5dc3dec913"
    $a3="adc91e03060b42e7836bdfba7ce19b3bc1297d234fec44585472529d"
...
rule sha512_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="afd66cdf7114eae7bd91da3ae49b73b866299ae545a44677d72e09692cdee3b79a022d8dcec99948359e5f8b01b161cd6cfc7bd966c5becf1dff6abd21634f4b"
    ...
    $a3="c6001d5b2ac3df314204a8f9d7a00e1503c9aba0fd4538645de4bf4cc7e2555cfe9ff9d0236bf327ed3e907849a98df4d330c4bea551017d465b4c1d9b80bcb0"
...
rule sha256_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="3ef411623fc41f2528234c7522c7d52eacc96bdbb18f3194ddf8b511a53d43a1"
    ...
    $a3="9af15b336e6a9619928537df30b2e6a2376569fcf9d7e773eccede65606529a0"
...
rule blake2b_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="abb1016fb3563a13d953bee26f60c51a162f577b4ece6fbd8a8d7126e8e178f54f6eb8fd3358bc32421a6ec1cec1dc3aa1543f9a47ede4a31fc14b7c9f949aa5"
    ...
    $a3="3b8565b7d15b7cf1cb681d5bfb0fff2326212746772d6676d9daed2eb9422c0b1fdd6446c4c18127e2a791d431994935a69d6ff468916167af1db23d95eea8cd"
...
rule blake2s_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="ac323779170e095f81eedfb81de9ac043bb0fd5ec96c6ca79f49a923b1e0b260"
    ...
    $a3="1b23aa0241350289fc70cf9372437d9a021b875b8baa558b15b0b7687952ec73"
...
rule sha3_224_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="5901aaa631c24f14c413c2002f678243aab5feff3ecba29e5e7b6d6a"
    $a1="6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7"
    $a2="a3c540c56f53058e38a1a05d992c0196ccda6c35e47dfc695c453a3c"
    $a3="70afec1674af6485ab6713729de000542e1b43d45ba368f55c271c41"
...
meta:
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="d523555197f79870fd7b4b0a5fe8dc6f64e5b260174bba44d815a212c5eaf670"
    ...
    $a3="a6af70b7af3f42352d783e8b07515e433c3d45669d4efee670516727193b291b"
...
rule sha3_384_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="b788ba34f67206e98ad93827281267bf8bc6f25e747b606e7a5b0fda3533dc5fb2e943df3970f6506761dbf0c945bc3f"
    ...
    $a3="adff06f440f7f2ec74a4141631d1cf89a142a28a58b252516e09027846a40f35608029e5b46af8cb15d1cd552262eaad"
...
rule sha3_512_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
    ...
    Description="Hashed values of default credentials for snom. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="40c81e7e58de1240f253b52abeb620dc041c858ff45adfa9777c17e98c37cf1d3a0a10e67777c6367d6f5182fb1fc6d9b323126b9358a03f581b6ea395b12abc"
    ...
    $a3="b678ce98622f627b5b35ca1e8f656f1bd33545d242b59f015a31de938afa3afbe685385b8e3cc9ff37d8c2af86eebfd319eed65abdb4be4181cd42ee4f370f61"
...
rule base64_hashed_default_creds_snom
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
