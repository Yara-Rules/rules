...
rule md5_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for axis_web. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="63a9f0ea7bb98050796b649e85481845"
    $a1="21232f297a57a5a743894a0e4a801fc3"
    $a2="63a9f0ea7bb98050796b649e85481845"
    $a3="1a1dc91c907325c69271ddf0c944bc72"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha1_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="9d4e1e23bd5b727046a9e3b4b7db57bd8d6ee684"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha384_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="ad111970708aaff07524d81f71582952b75ade74951ebb3c25e801fc4a3f17de8d3e8fbc7c271114462fe63f67d33536"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha224_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="ccc9c73a37651c6b35de64c3a37858ccae045d285f57fffb409d251d"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha512_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="5b722b307fce6c944905d132691d5e4a2214b7fe92b738920eb3fce3a90420a19511c3010a0e7712b054daef5b57bad59ecbd93b3280f210578f547f4aed4d25"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha256_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="d74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2b_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="43886c4979efcf7990b5283dc2826b5d7247407adf002b3a95f6b04ebf5e483fe3ed435c8ba731492f0cc99c7af8221917e720d6ab41c8ce7f6afcc91392c159"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2s_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="4f5a01bbbf0ce658abcacc64c7efdb3f108a18705ca66196340090bedc11f431"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_224_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="30c04cbad71a234a295ef6445ce18fbf2e39b83e054b93e6030e305c"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_256_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="73899d2adaad774417b0208da85162b61c8dbdf79bb0f7108c2686b93721d1f4"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_384_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="36d841bb32fc5ef1a5704652097584ee789f4d2e745fa283516320163dba0d699b5a502de4f33321155dc5715e0c1e4d"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_512_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="62f264d7ad826f02a8af714c0a54b197935b717656b80461686d450f7b3abde4c553541515de2052b9af70f710f0cd8a1a2d3f4d60aa72608d71a63a9a93c0f5"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule base64_hashed_default_creds_axis_web
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
