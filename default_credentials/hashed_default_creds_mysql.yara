...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="e64c7d89f26bd1972efa854d13d7dd61"
    $a1="21232f297a57a5a743894a0e4a801fc3"
    $a2="63a9f0ea7bb98050796b649e85481845"
    $a3="d41d8cd98f00b204e9800998ecf8427e"
    $a4="024802c1acb70ae12510effc1779cfa2"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="ed04075d091ca0dcc9d921a9e2c40836cae182a39f5d13938c3beb90ec8ccd1240f23816e4e7181542a53cdea3e0bc98"
    ...
    $a4="6717a216428b87c8a69bdafc870da66b24082b1d52cc99d423dadbd12a203a6b906dee8d76e3952a4deb4413cd63200a"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="51c6c172236eec7c5a11a6f2b467794efe4346bfd55df14c527f99d9"
    ...
    $a4="d619d8ffb8c54c1612eb466f6281761fe01b35fbf2b03b3ef55d4d47"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="fc063b5c2ad541510b5e178a237d975dd4bbc74acf10f03d1a1fd901be6581945d53da7ce4b42c6baa0499015d64689cf5d578f37c0106ed7c9d10564869b8b6"
    ...
    $a4="77e53647dddbeb1bc6abe20ed13a846c5cda2b29ed69596564acf090e31f7e0449ffd4ae5704dee6e7f925c5b856dbbbc8248e4c1c03d47dbff1d7c4f327193e"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="258d8dc916db8cea2cafb6c3cd0cb0246efe061421dbd83ec3a350428cabda4f"
    ...
    $a4="18e865e45cfb289190334568607941627ee412c1e776c8337fa30b73e382f1d0"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="4485295e8d76771c856d20e3ed1167abc172b743fb71b5c23d823c16e51de46f550877b0420444990a3d5b2cae2a13bb141f0484fae5ae0f62190b33acd8198a"
    ...
    $a4="65aa9e9ce6e9097d5b7056e4d9e57d7efa697a24be1deb0a29b68fcde827c6df578050005433faeb36b9294426e566ca9acece940f726749748e2ad2c945f7ff"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="3b4a2055d1a2ef521001969af21b96e94697a132a90df9769cbaee4c199b291e"
    ...
    $a4="33e7531b37bdfe5ed593baa7fcbbe7ffc942fba5a97b992715ac24ce67b9f140"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="b782c0aede1a4d90af5806fc51d8bf6cd790879f65b20cc56a7fa5a0"
    ...
    $a4="cb290936258c46273106baeeed30c4112bfc7b164d8f1b6d0030d1a4"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="f157dbcb0ca3e3ec661818c5b21acd3c7933095edcb40a2dee37c3021a96d646"
    ...
    $a4="a64912cfdca304264e4ee1226441949f557136e7f28a8347e4661f8c302b9ced"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="a9bf1290ed7ec6dd984d16635133a1a36568b43431934886f06e1c3190a036802a1ede2d49cb844750b7680dba2c29fc"
    ...
    $a4="a31cd67ad8781deb9842fed707eb8f533e5e92e74576773870d89a4464b26c18fc1ece288b5b9817c33bfa4e0833f6c4"
...
meta:
    ...
    Description="Hashed values of default credentials for mysql. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="007651c92023c439c74dc465e9e5076ed91297a203bad0d1c557d601af11e238310fac3a34fc12ebaa3da319b0392ab0d7568ec56e0d923f8fae25775db6c258"
    ...
    $a4="2f2f915df70f34d0a1a0230ecafeaf3a6883f86629918b3bcad2ee8907c72e16631e125410e509bc3f15efd0bb3ed49b74d4e4ba640910553930e9b69c509455"
