...
rule md5_hashed_default_creds_omron
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for omron. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
...
rule sha384_hashed_default_creds_omron
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha512_hashed_default_creds_omron
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule sha256_hashed_default_creds_omron
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
rule base64_hashed_default_creds_omron
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
