...
meta:
    ...
    Description="Hashed values of default credentials for belkin. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    ...
    $a5="e5e2090404358484a7c15c5841e5b626"
condition:
...
strings:
    ...
    $a5="52be56c79f9e7f5926cb09d61e9f442547b74698"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="083e6a5d8045e80108380a0e94e62f1d2aaf05294f2616d1d37f11d820ff6e62f5f3f03db85e5aed0684cb6f599596cf"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="7baf3509fe14bcff445b3e01ece8d1faeb6000f7afc22e5b95334818"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="659fd2e67c17b457e4fae1ed1240e37c3b266cc40b93d048035414f4213f61d0d962c57893f80040d59673aa607588d386141a54fa9c837f327c6df876e22236"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="c20734974a8a99c1d5f31a201025962389d002892edad7ffd30281fbce8d4c4c"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="60a8462ff6c9d618550acb1c4e996e669867a86407f52ad524d0d430a4f1386c96fbf552ed25a6f6c7afd3fcbd9490f8c07d9f1b2eebb16701a4d667a194fc46"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="02f1b055ec2a80cb3e8d6d7b4d7ef9a73021dfe393512f6775c93dbb075c745e"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="6ba3f9eb4a06cd1aafd500ad7f28b817f570f8c017da70cf6f5b54c7"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="77b741c767d36b3a4077935324a5286dc72d2143b0a9367da0687e790d5cc348"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="0c9507524ccdfdb6afe75b2950cb8b6b2b1a61fcd2967e774de22062a98cdcb95dce8d84712e2c5b5ba123e9f4e93fea"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="299c84135916947f4bb3c8837023fef70b01ebcf2d33d81e86108f7e27fed646b2fa0698b4286474c487d03b893d5693dfaa6fb479a6f459eac539553c19c0e6"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
