...
meta:
    ...
    Description="Hashed values of default credentials for alteon. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    ...
    $a5="51520583bfff5faf5828fa0db30a6566"
condition:
...
strings:
    ...
    $a5="32059340a9db67147ec19b168e330a3fd9dd2135"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="464f7c45800471f32c6a82b6d79fa9dff6fae85c4cf0e01d64f5a593a8f9e5f7c72106e82794b57cbde371d0637dc4bc"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="e3ac3752d43fd5f891709fe1282f02a6cc8201230b5cbadf21b0b19a"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="3ec92f1b60020bcbb18de14a4b915049a7280ebb22da4cc3130ae854c4ad38c581d3b62fc01fbfc5c07597e686a0d0d51b9dcf8b9aa84df32ac83c03840811f3"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="1fb165e6d5e4539917eaaa3ad4d8cfeceb2873ff760b39b6d1420bdf2c47775f"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="bf9927d2449be24cca97589b5ae5b706b6d59626b8eb2974b7b71d6fbb55d6073679e3c4228c6152a6193ada6bf0635d845347ee2f0ef9907f4432bd59165086"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="e7dfe104d216e50968790bf906bc2c80853b023d575489ac27f42c176a94c5dc"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="229e368153b7902bbf600d00dd02b77f50b90d57a995f2c1788b874d"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="0a58efa69893717e9c8ec163b21a4e78be3c4bec29c7203fced2a155111a7c66"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="8cbaa15d485cccc172614ea44a2ec4e4d108b291125715c4c97bbc1dffef56f0387daa92f76496c9ba510960c4aa2130"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a5="85a597aad02ca8e97b8597c0432806060f15c84a6f7825ea3b486f462ddc82de22d51ca1677478aabcd6f3c5fa667613d835849f57255cf90cef88a3e49fe9cc"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
