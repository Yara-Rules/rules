...
meta:
    ...
    Description="Hashed values of default credentials for typo3. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="21232f297a57a5a743894a0e4a801fc3"
    $a1="5f4dcc3b5aa765d61d8327deb882cf99"
    $a2="d41d8cd98f00b204e9800998ecf8427e"
    $a3="bacb98acf97e0b6112b1d1b650b84971"
condition:
...
strings:
    ...
    $a3="063b3d108bed9f88fa618c6046de0dccadcf3158"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="9ee5fd097104a693c132e743ad902305a3ecf6fbd34bee780af771dd03a20d9e458c25846e12a0603cbef4dba826d84c"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="2161d9ab381a0e97c072a83a1f5d74f2ded275fd8c8147b96a048be3"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="25cf4d9cb1f92c135ea9556bfed46a1d5f97297a16310a15e28bb193c332a17d6534050d28ce9d2c970622b53fb55b8ee937b93c9b885142acebbf71c0da9426"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="a5f20a1d772b986ae5671fccec74548ddadd79191b2b7e66ef0632792a138322"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="86fbdc3b4b1b509e95f535d4f4b2bed538973032c46cd625a1af564696fc265f090aea54db224dd74fa244063214fe0540d86db14aee0bc9adfe099562f187bb"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="f84826f68d6975232d98afb27710ab69a20b7ad7108ce04c6f910b463a186a4e"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="59bd354b8e78c45f9cc8122ddbfa48beeb5b96495e8e9eec56b6219b"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="384d7ddf9180ee2edf0630e337df65d3255236afc2dc2f97a3858534e28a82e6"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="d57d295ac4fa5e2081b6810bdc11c9a63dfcef28277bd3120a883b4ffd8399b3dcf286861932f30de8192a1e48e4c906"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
...
strings:
    ...
    $a3="41b1bb49707d46275b24cd4e0443990dcb8ee0b53847fdb8037c014863d1a7c7306e747951423eb163c227adea824bcae3accd3b031a400ca40c34f09022b354"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}
