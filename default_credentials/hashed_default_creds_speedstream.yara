...
meta:
    ...
    Description="Hashed values of default credentials for speedstream. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    ...
    $a7="07b3e6fe5aa4ddce09d3eca317e26412"
condition:
...
strings:
    ...
    $a7="407f5ce9a9217c5ee6a22d3d8a424dd3f05a9816"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="42ed9c68e340398c8b5827ced53404525f6ae2b6966410e380324a815e03b42563a99caa4da35229fb55667466d213cb"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="f2e718be4066b2d7a31553a24e905a83d7befa306e0981a9b22c0ab7"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="f82e7f86b07e6ea78dcf991a6a4fcc56ae249862f1fcdd83cd1414fc006257537e6165b0a2ecf896e6dd3fcb513dd99b7e8aece8dc78f2f6422f2d87a60fad24"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="80f7bce5b6f1ddb05b22fd5ff65c8bc3ad7a69b01e9fe00a7fd5ca03779793e6"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="7fb9b577c2b451504aaa6385adfda1fbd0d934faadfdba867d3d811fe75d1ed5fc65f3b72433813afe695f1bd49b624c912510f258b5c33795aea493cec38359"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="1e8670298f259e0ceb0bdc8da2df43e468c5df330e0e3443e9f7fb620b5fc4e6"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="41b252a583a8d622fa0062720ae738936ecb2c771decdb13d40f4a44"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="81173e2b4545e7ee8988de6a267d44617503d77d934d0b1b65c2ee494f65e95e"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="75555d1e20d6eb1e8be0b2244aa36eaed002f5c66f913187aec6873f91cc502715bf38f5b04a305ba8b26d660bb80c65"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
...
strings:
    ...
    $a7="36159a2f37e967245f67ff1da20ece4dbe4faaebf89cb75328929bbf163a394d9467ab65a988f5801c55c16f0fcc78da37071b6da1aa89ec0971e6c5cfabae35"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5) or ($a6 and $a7)
}
