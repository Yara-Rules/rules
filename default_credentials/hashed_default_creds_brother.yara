...
rule md5_hashed_default_creds_brother
{
meta:
    Version="0.1"
    ...
    Description="Hashed values of default credentials for brother. Credentials available on https://gitlab.com/ndaal_open_source/ndaal_yara_passwords_default/-/blob/main/DefaultCreds-Cheat-Sheet.csv"
strings:
    $a0="21232f297a57a5a743894a0e4a801fc3"
    $a1="9df3b01c60df20d13843841ff0d4482c"
    $a2="d41d8cd98f00b204e9800998ecf8427e"
    $a3="9df3b01c60df20d13843841ff0d4482c"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha1_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="0f12541afcce175fb34bb05a79c95b76e765488b"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha384_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="49e18e684812e9034a6c1eef90b337cbc9ee8de6383e57b79f4bc255393417ab33def30f0f3398c5489c00faab52a619"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha224_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="24289a24be5d6ee8df8f3cedf9b538b4cb69fbaf8abca98797b328ac"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha512_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="932778fa1dd9a15dac1f6d7690b29b70e9c205a8d2b4a437f007bf6df4fe3c5200520078f95184bd37ce6ed67f362a42b4263ed4c8ba6d777b0166f9af879897"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha256_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="a0561fd649cdb6baa784055f051bad796ea0afef17fca38219549deeba4e8c1a"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2b_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="3668a081b0929274a97abf15209dab17ae30a35a7751a62e5515262524cb38b5216cff0ed604cf6a8f5f5b573aa0573735764a99a6028f22e0d2ea1eaaac810c"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2s_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="13ed751afcecd936bcbe496a38545e63d2fb97f2ad8fc5b72f17d29784c34db5"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_224_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="a86118aed12772c63e1641003f22dadc2be7ee74d4cb33aeb0b3466d"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_256_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="1037f1f67277cd916301c10e5417b95c117abbd8daf2b794c30a90ee67898b53"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_384_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="8515c138c59d8d72b3d9ec1bb64c0ee8f1d8e270d29c1eb632b0ae048661bf0121c24c7749166760a022f8c2d48fab62"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_512_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
...
strings:
    ...
    $a3="2ccefc4001cc12acc9512f44784c55dff5086894fd436dfcb30f64a2c5a55dbae984b86c749d29e10254c770f3b21ca6fc11d84ddd9077db29c6e6bcb4c48f24"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule base64_hashed_default_creds_brother
{
meta:
    Version="0.1"
    Author="Alaa Jubakhanji"
